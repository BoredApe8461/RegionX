...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId } xcRegionsContract,
	* @param { (string | number | BN) } listingDeposit,
	*/
   	async "new" (
		xcRegionsContract: ArgumentTypes.AccountId,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, xcRegionsContract, listingDeposit);
			let response;
