...
export default class EventsClass {
	...
	public subscribeOnRegionInitializedEvent(callback : (event : EventTypes.RegionInitialized) => void) {
	...
	public subscribeOnRegionRemovedEvent(callback : (event : EventTypes.RegionRemoved) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			const _event: Record < string, any > = {};
