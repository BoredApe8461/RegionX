...
export default class EventsClass {
	...
	public subscribeOnRegionListedEvent(callback : (event : EventTypes.RegionListed) => void) {
	...
	public subscribeOnRegionPurchasedEvent(callback : (event : EventTypes.RegionPurchased) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			const _event: Record < string, any > = {};
